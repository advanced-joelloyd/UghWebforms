...
{
    public partial class ReUploadDoc : System.Web.UI.UserControl
    {

        public delegate void MatterDocReUpload(object sender, EventArgs e);

        public event MatterDocReUpload DocReUpload;
        protected virtual void OnDocReUpload(EventArgs e)
        {
            if (DocReUpload != null)
            {
                DocReUpload(this, e);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request.QueryString["ReUploadDoc"] != null)
                {
                    _PnlReUploadDocControls.Visible = true;
        ...
        protected void _btnBack_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _PnlReUploadDocControls.Visible = false;
        ...
        {
            _PnlReUploadDocControls.Visible = IsVisible;
        }
