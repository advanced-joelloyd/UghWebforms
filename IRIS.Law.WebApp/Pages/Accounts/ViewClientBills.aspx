<%@ Page Language="C#" MasterPageFile="~/MasterPages/ILBHomePage.Master" AutoEventWireup="true"
    CodeBehind="ViewClientBills.aspx.cs" Inherits="IRIS.Law.WebApp.Pages.Accounts.ViewClientBills"
    Title="View Client Bills" %>

<%@ Register TagPrefix="CliMat" TagName="ClientMatterDetails" Src="~/UserControls/ClientMatterDetails.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="_contentClientBills" ContentPlaceHolderID="_cphMain" runat="server">
    <asp:UpdateProgress ID="_updateProgressMatter" runat="server">
        <ProgressTemplate>
            <div class="textBox" runat="server" id="_divProgressMatter">
                <img id="_imgClientBillsLoadIndicator" src="~/Images/indicator.gif" runat="server" alt="" />&nbsp;Loading...
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>
    <table width="100%" border="0">
        ...
        <tr>
            <td colspan="2">
                <asp:UpdatePanel ID="_updPanelClientBills" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="_grdClientBills" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                            OnRowDataBound="_grdClientBills_RowDataBound" BorderWidth="0" GridLines="None"
                ...
                <asp:ObjectDataSource ID="_odsClientBalances" runat="server" SelectMethod="LoadClientBalancesDetails"
                    TypeName="IRIS.Law.WebApp.Pages.Accounts.ViewClientBills" EnablePaging="True" MaximumRowsParameterName="pageSize"
                    SelectCountMethod="GetClientBalancesRowsCount" StartRowIndexParameterName="startRow"
                    OnSelected="_odsClientBalances_Selected">
                    <SelectParameters>
