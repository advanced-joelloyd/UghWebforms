<%@ Page Language="C#" MasterPageFile="~/MasterPages/ILBHomePage.Master" AutoEventWireup="true"
    CodeBehind="ViewOfficeBills.aspx.cs" Inherits="IRIS.Law.WebApp.Pages.Accounts.ViewOfficeBills"
    Title="View Office Bills" %>

<%@ Register TagPrefix="CliMat" TagName="ClientMatterDetails" Src="~/UserControls/ClientMatterDetails.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="_contentOfficeBills" ContentPlaceHolderID="_cphMain" runat="server">
    <asp:UpdateProgress ID="_updateProgressMatter" runat="server">
        <ProgressTemplate>
            <div class="textBox" runat="server" id="_divProgressMatter">
                <img id="_imgOfficeBillsLoadIndicator" src="~/Images/indicator.gif" runat="server"
                    alt="" />&nbsp;Loading...
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>
    <table width="100%" border="0">
        ...
        <tr>
            <td colspan="2">
                <asp:UpdatePanel ID="_updPanelOfficeBills" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="_grdOfficeBills" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                            OnRowDataBound="_grdOfficeBills_RowDataBound" BorderWidth="0" GridLines="None"
                ...
                <asp:ObjectDataSource ID="_odsOfficeBalances" runat="server" SelectMethod="LoadOfficeBalancesDetails"
                    TypeName="IRIS.Law.WebApp.Pages.Accounts.ViewOfficeBills" EnablePaging="True" MaximumRowsParameterName="pageSize"
                    SelectCountMethod="GetOfficeBalancesRowsCount" StartRowIndexParameterName="startRow"
                    OnSelected="_odsOfficeBalances_Selected">
                    <SelectParameters>
