<%@ Page Language="C#" AutoEventWireup="true" 
    Title="Change Password" MasterPageFile="~/MasterPages/NoControls.Master" CodeBehind="ForceChangePassword.aspx.cs" Inherits="IRIS.Law.WebApp.Pages.Password.ForceChangePassword" %>
...
<asp:content id="Content1" contentplaceholderid="_cphMain" runat="server">
    ...
    <table cellpadding="2">
    <tr>
        <td class="boldTxt" colspan="2"><asp:Label runat="server" id="_lblMessage" Text="It is recommended you change your password. If you wish to keep your current password please press Continue."></asp:Label> </td>
    </tr>
    <tr>
        <td align="right" colspan="2">
            <div class="button"><asp:Button ID="_btnContinue" runat="server" 
                CausesValidation="False" Text="Continue" onclick="_btnContinue_Click" /></div>
        </td>
    </tr>
    </table>
    <asp:Panel runat="server" ID="_pnlChangePassword">
     <table cellpadding="2">
    <tr>
    ...
    <tr>
        <td align="right" colspan="2">
            <table cellpadding="2">
            <tr>
                <td> <div class="button"><asp:Button ID="_btnSubmit" runat="server" 
